...
Sou um profissional com mais de 12 anos de trajetória em Tecnologia da Informação e Telecomunicações, com expertise em infraestrutura de redes.  Atualmente, estou em constante capacitação técnica em **Cibersegurança**, com foco em **Red Team e Penetration Testing**, buscando integrar conhecimentos ofensivos de segurança às soluções que projeto e gerencio.
...
- 💻 Apaixonado por tecnologia, segurança ofensiva e inovação.  
- 🔴 Especialista em desenvolvimento: **Red Team e Penetration Testing** 
- 🔐 Dedicado a fortalecer redes através de testes de segurança e validação de controles.  
- 📚 Em constante capacitação técnica em Cibersegurança.  
- 🚀 Sempre em busca de desafios que ampliem minha visão técnica e estratégica.  
- 🌐 Interesse em projetos desafiadores que façam evoluir minhas competências. 
